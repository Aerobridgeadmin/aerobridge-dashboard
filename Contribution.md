...
1. Go to the apps/aerobridge directory of your installation and execute git pull --unshallow to ensure that you have the full git repository. Also fork the Aerobridgeadmin/aerobridge-dashboard repository on GitHub.
