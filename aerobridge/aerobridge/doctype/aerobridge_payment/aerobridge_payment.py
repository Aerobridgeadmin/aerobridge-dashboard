...
from aerobridge.aerobridge.utils import get_aerobridge_route
...
def is_batch_sold_out(payment):
	if payment.payment_for_document_type == "Aerobridge Batch":
		seat_count = frappe.get_cached_value("Aerobridge Batch", payment.payment_for_document, "seat_count")
		number_of_students = frappe.db.count("Aerobridge Batch Enrollment", {"batch": payment.payment_for_document})
...
def send_mail(payment):
	...
	custom_template = frappe.db.get_single_value("Aerobridge Settings", "payment_reminder_template")
