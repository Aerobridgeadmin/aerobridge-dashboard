...
class TestLMSQuiz(unittest.TestCase):
	...
	def setUpClass(cls) -> None:
		frappe.get_doc({"doctype": "Aerobridge Quiz", "title": "Test Quiz", "passing_percentage": 90}).save()
	...
	def tearDownClass(cls) -> None:
		frappe.db.delete("Aerobridge Quiz", "test-quiz")
		frappe.db.delete("Aerobridge Question")
