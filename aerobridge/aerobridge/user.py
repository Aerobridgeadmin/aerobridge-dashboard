...
from aerobridge.aerobridge.utils import get_country_code, get_aerobridge_route
...
def after_insert(doc, method):
	doc.add_roles("Aerobridge Student")
...
def sign_up(email: str, full_name: str, verify_terms: bool, user_category: str):
	...
	user.add_roles("Aerobridge Student")
...
def on_login(login_manager):
	...
	if default_app == "aerobridge":
		frappe.local.response["home_page"] = get_aerobridge_route()
