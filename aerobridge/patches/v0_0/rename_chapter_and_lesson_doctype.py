...
def execute():
	frappe.reload_doc("aerobridge", "doctype", "course_chapter")
	frappe.reload_doc("aerobridge", "doctype", "course_lesson")
	frappe.reload_doc("aerobridge", "doctype", "chapter_reference")
	frappe.reload_doc("aerobridge", "doctype", "lesson_reference")
	frappe.reload_doc("aerobridge", "doctype", "exercise")
	frappe.reload_doc("aerobridge", "doctype", "exercise_submission")
...
def move_chapters():
	...
	for doc in docs:
		if frappe.db.exists("Aerobridge Course", doc.course):
			name = doc.name
