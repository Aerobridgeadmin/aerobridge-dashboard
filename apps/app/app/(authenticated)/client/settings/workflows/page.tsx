...
const WorkflowsPage = async () => {
  ...
  return (
    <>
      <Header page="Workflows" pages={["Client Portal", "Settings"]} />
            ...
            <div key={wf.id} className="rounded-xl border bg-card p-5">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className={`rounded-full px-2 py-0.5 text-xs ${wf.isActive ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-500"}`}>
