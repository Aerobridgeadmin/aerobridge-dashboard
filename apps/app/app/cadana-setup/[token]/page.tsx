import { getEmployeeForCadanaSetup } from "@/app/actions/hriq/cadana-setup";
import type { Metadata } from "next";
import { CadanaSetupForm } from "./cadana-setup-form";

export const metadata: Metadata = {
  title: "Set Up Payment Details — Remote Leverage",
  description: "Set up your Cadana payment details to receive contractor payments.",
};

export default async function CadanaSetupPage({
  params,
}: {
  ...
  let employee;
  try {
    employee = await getEmployeeForCadanaSetup(token);
  } catch {
    employee = null;
  }
  ...
  // If Cadana setup is already complete, show success
  if (employee.cadanaSyncedAt) {
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
        <div className="w-full max-w-md text-center">
          ...
          <p className="mt-2 text-sm text-gray-400">
            Thank you, {employee.legalFirstName}! Your Cadana payment details are already configured. No further action is needed.
          </p>
